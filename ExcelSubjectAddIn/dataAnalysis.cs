...
namespace ExcelSubjectAddIn
{
    class dataAnalysis
    {
        ...
        {
            ClassSheet.Cells[1, 1] = "2015级计算机科学与技术（师范）";
            ...
            ClassSheet.Cells[2, 2] = calClassAverageScore(ClassSheet,6);    //统计第5列的均值
            ClassSheet.Cells[3, 1] = "班级平均绩点";
            ClassSheet.Cells[3, 2] = calClassAverageJD(ClassSheet,3);   //统计第3列的均值
            ClassSheet.Cells[4, 1] = "不及格率";
            double ClassUnpassRate = calClassUnpassRate(ClassSheet, 4);//统计第4列的和，再除以总考试次数
            ClassSheet.Cells[4, 2] = ClassUnpassRate.ToString("P", provider); 
            ClassSheet.Cells[5, 1] = "四级通过率";
            double ClassG4passRate = calClassG4passRate(importWorkSheet);//统计第4列的和，再除以总考试次数
            ClassSheet.Cells[5, 2] = ClassG4passRate.ToString("P", provider);
            ClassSheet.Cells[6, 1] = "六级通过率";
            double ClassG6passRate = calClassG6passRate(importWorkSheet);
            ClassSheet.Cells[6, 2] = ClassG6passRate.ToString("P", provider);
        }
        //统计不及格科目数
        ...
        {
            LessonSheet.Cells[1, 1] = "2015级计算机科学与技术（师范）";
