...
namespace ExcelSubjectAddIn
{
    public partial class ThisAddIn
    {
        ...
        private void OnExcelWorkbookActivate(Excel.Workbook Wb)
        {
            ...
            //补丁V1.0 防止提前点击任务窗口
            share.TaskPane_Ready = 0;
            share.myUserControl_Lesson.AllButtonDisable();
            share.myUserControl_individual.AllButtonDisable();
        ...
        void ReportEventWithSheetParameter(string eventName, object sheet)
        {
            ...
            if (worksheet != null && share.TaskPane_Ready== 1)
            {
